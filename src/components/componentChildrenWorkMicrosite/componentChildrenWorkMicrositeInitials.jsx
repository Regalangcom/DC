...
import { InitiaLDesignMicro } from "../../constant";

const ComponentChildrenWorkMicrositeInitials = () => {
...
export default ComponentChildrenWorkMicrositeInitials;
