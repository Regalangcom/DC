...
import { choco3 } from "../../assets";
const ComponentChildrenWorkChocoCard = () => {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center px-4 py-10 w-full min-h-screen overflow-hidden">
      ...
      <motion.div
        ...
        className="fixed left-0 top-0 w-8 h-8 rounded-full  bg-greeDC  z-[999] pointer-events-none"
        style={{
...
export default ComponentChildrenWorkChocoCard;
