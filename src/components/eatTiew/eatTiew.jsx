    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-between w-full">
        ...
        <div className="w-full max-w-[400px] md:max-w-[52vw] md:h-[95vh] overflow-hidden rounded-3xl  relative z-10 mb-4">
          <Link to="/harvest-dental" style={{ cursor: "none" }}>
        ...
        >
          ...
          <p className="font-fontDC md:text-[24px] mt-2 mb-4">
            We worked with Eattiew to increase sales of products offered through
            social media marketing, by providing creative and attention-grabbing
            content.
          </p>
