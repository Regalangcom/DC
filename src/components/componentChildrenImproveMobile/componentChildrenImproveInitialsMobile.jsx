...
import { InitiaLDesignImproveUI } from "../../constant";

const ComponentChildrenImproveInitialsMobile = () => {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center px-4 py-10 w-full min-h-screen overflow-hidden">
      <div className="flex flex-col gap-10 w-full items-center">
        {InitiaLDesignImproveUI.map((item) => (
          <div
            key={item.id}
...
export default ComponentChildrenImproveInitialsMobile;
