...
const ChildrenEatiew = () => {
  ...
  return (
    <>
      <div className="flex flex-col max-w-[1440px] justify-center  items-center md:mt-[7%] relative px-6 sm:px-[72px]">
        ...
        <div className="flex flex-col relative w-full  left-[200px] mb-24 mx-auto">
          <div className=" md:text-[64px] text-[18px] text-textDC font-fontDC leading-snug md:leading-tight">
            <p className=" md:text-[32px]">Harvest Dental Care</p>
            <p>Propel your business to the next stage</p>
          </div>
        </div>
