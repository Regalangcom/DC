...
import { InitiaLDesignEatiew } from "../../constant";

const ComponentChildrenWorkEatiewInitials = () => {
...
export default ComponentChildrenWorkEatiewInitials;
